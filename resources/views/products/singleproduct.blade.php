                        ...
                        @if(isset(Auth::user()->id))
                            @if($checkInCart > 0)
                                <button disabled type="submit" name="submit" class="mt-3 btn btn-primary btn-lg">
                                    <span class="item-count">{{ $totalItemsInCart }}</span>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                                ...
                                <div class="item">
                                    <div class="card card-product">
                                        ...
                                        <div class="card-badge">
                                            ...
                                            <img src="{{asset('assets/img/' . $relatedProduct->img . '')}}" alt="Card image 2"
                                                class="card-img-top">
                                        </div>
                                        <div class="card-body">
                                            <h4 class="card-title">
                                                <a
                                                    href="{{route('single.product', $product->id)}}">{{$relatedProduct->name}}</a>
                                            </h4>
                    ...
                    @else
                        <p class="alert alert-succcess">there are not related products in this category just now</p>
                    @endif
                </div>
            </div>
        </div>
