...
<body>
                                ...
                                <li class="nav-item dropdown">
                                    <a class="nav-link dropdown-toggle" href="javascript:void(0)" id="navbarDropdown"
                                        ...
                                        <div class="avatar-header"><img
                                                src="{{asset('assets/users_images/' . Auth::user()->image . '')}}"></div>
                                        {{ Auth::user()->name }}
                                    </a>
    ...
    <footer>
            ...
            <div class="row">
                ...
                <div class="col-md-3">
                    ...
                    <ul>
                        ...
                        <li>
                            <a href="mailto:freshfood@gmail.com"><i class="fa fa-envelope"></i> freshfood@gmail.com</a>
                        </li>
                    </ul>
        ...
        <p class="copyright">&copy; 2025 FresFood | Organic Store. All rights reserved.</p>
    </footer>
    ...
    <script type="text/javascript"
        src="{{ asset('assets/packages/bootstrap-touchspin/bootstrap-touchspin.js')}}"></script>
